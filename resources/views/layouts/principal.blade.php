				...
				<ul class="nav" id="side-menu">
					...
					<li>
						...
						<ul class="nav nav-second-level collapse" id="ulInventario">
							<li>
								<a href="#ulInventarioProductos" data-toggle="collapse">Productos <span class="fa arrow"></span></a>
							...
							<li>
								<a href="#ulInventarioProveedores" data-toggle="collapse">Proveedores <span class="fa arrow"></span></a>
							...
							<li>
										<a href="#ulInventarioCategorias" data-toggle="collapse">Categorias <span class="fa arrow"></span></a>
...
<!--footer-->
<div class="footer">
	<p>FACIN | Facturación e Inventario - Desarrollado por <a href="https://dpsoluciones.co/" target="_blank">DPSoluciones</a></p>
</div>
<!--//footer-->
</div>
<!-- Classie -->
